"""
Reviewer Agent — Integration reviewer that checks frontend/backend alignment.
Runs AFTER frontend, BEFORE testing. Catches API mismatches early.
...
_config = get_agent_config("reviewer")
